...
namespace WebApplication2.Report {
    ...
    public class MachineList : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "WebApplication2.Report.MachineList.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedMachineList : Component, ICachedReport {
        
        public CachedMachineList() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            MachineList rpt = new MachineList();
            rpt.Site = this.Site;
            return rpt;
        }
